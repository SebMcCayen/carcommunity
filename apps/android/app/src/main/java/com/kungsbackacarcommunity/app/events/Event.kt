...
object Events {
    ...
    /** Paid roster access; admins retain moderation access. Full details and RSVP are free. */
    fun canViewAttendees(isAdmin: Boolean, isPaidSubscriber: Boolean): Boolean =
        isAdmin || isPaidSubscriber
