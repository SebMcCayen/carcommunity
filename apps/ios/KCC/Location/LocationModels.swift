...
struct LocationFix: Equatable, Sendable {
    ...
    /// Whether CoreLocation says this fix was generated by software rather
    /// than positioning hardware. Nil means the platform did not expose the
    /// signal; consumers must not treat unknown as evidence of simulation.
