...
| Phase 2 — Language-neutral contracts (`contracts/` directory: schemas, error codes, callable function names, feature flags, localization, design tokens)                                                                                                                             | 🟡 In progress — PR 2a: structure, README, auth + user profile schemas, error codes; 2b–2d remain |
