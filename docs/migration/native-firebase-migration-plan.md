...
| Phase 2 — Language-neutral contracts (`contracts/` directory: schemas, error codes, callable function names, feature flags, localization, design tokens)                                                                                                                             | 🟡 In progress — PR 2a: structure, auth + user profile schemas, error codes. PR 2b: live location + events/RSVP schemas, callable function registry, feature flags. PR 2c: localization (sv/en) seeded with key parity CI-enforced. 2d (design tokens) remains |
